...
#{Gem.ruby}: No such file or directory -- extconf.rb (LoadError)
  ...
  def test_generate_bin_bindir
    ...
    assert_match %r|generated by #{Gem::NAME}|, wrapper
  end
  ...
  def test_generate_bin_script_no_shebang
    ...
    #assert_no_match %r|generated by #{Gem::NAME}|, wrapper
  end
  ...
  def test_generate_bin_script_wrappers
    ...
    assert_match %r|generated by #{Gem::NAME}|, File.read(installed_exec)

    refute_match %r|generated by #{Gem::NAME}|, File.read(real_exec),
  ...
  def test_generate_bin_symlink_win32
    ...
    wrapper = File.read installed_exec
    assert_match(/generated by #{Gem::NAME}/, wrapper)
  ensure
  ...
  def test_install_wrong_rubygems_version
    ...
    use_ui @ui do
      ...
      assert_equal "old_rubygems_required requires #{Gem::NAME} version < 0. " +
        "Try 'gem update --system' to update #{Gem::NAME} itself.", e.message
    end
  end
